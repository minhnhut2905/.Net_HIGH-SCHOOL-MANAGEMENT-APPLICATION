...
namespace GUI.Nhang_CustomControls
{
    public class NhangDateTimePicker: DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.WhitePicker;
        ...
        public Color SkinColor { get => skinColor; 
            ...
            { 
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.BlackPicker;
                else calendarIcon = Properties.Resources.WhitePicker;
                this.Invalidate();
            } 
        }
